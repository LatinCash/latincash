...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 925524;	// address start with 'cash'
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 60 * 2;

const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;

const uint64_t MONEY_SUPPLY                                  = UINT64_C(500000000000);	// 50 mi coins
...
const char     CRYPTONOTE_NAME[]                             = "LatinCash";
...
const int      P2P_DEFAULT_PORT                              = 20634;
const int      RPC_DEFAULT_PORT                              = 20635;
...
const char* const SEED_NODES[] = { 
		"node1.latincashcoin.com:20634",	// vultr
		"node2.latincashcoin.com:20634"		// google cloud
	};
} // CryptoNote
